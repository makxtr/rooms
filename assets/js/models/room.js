...
(function () {
    ...
    function setModer(on) {
        ...
        if ((Room.moderator = on)) {
            // moderate.js and settings.js are now loaded during app initialization
        }
    ...
    function setAdmin(on) {
        ...
        if ((Room.admin = on)) {
            // ranks.js is now loaded during app initialization
        }
...
(function () {
    ...
    Room.shuffle = function () {
        return Rest.rooms.create("search").done(changeRoom).fail(shuffleFailed);
    };
})();
